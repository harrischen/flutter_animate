...
class ZoomInLeft extends StatefulWidget {
  const ZoomInLeft({
    Key? key,
  ...
  @override
  _ZoomInLeftState createState() => _ZoomInLeftState();
}

class _ZoomInLeftState extends State<ZoomInLeft> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return ZoomInLeftGrowTransition(
      child: widget.child,
...
class ZoomInLeftGrowTransition extends StatelessWidget {
  const ZoomInLeftGrowTransition({
    Key? key,

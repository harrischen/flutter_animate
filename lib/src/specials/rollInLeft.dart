...
class RollInLeft extends StatefulWidget {
  const RollInLeft({
    Key? key,
  ...
  @override
  _RollInLeftState createState() => _RollInLeftState();
}

class _RollInLeftState extends State<RollInLeft> with SingleTickerProviderStateMixin {

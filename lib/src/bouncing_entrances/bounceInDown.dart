...
class BounceInDown extends StatefulWidget {
  ...
  @override
  BbounceInDownState createState() => BbounceInDownState();
}

class BbounceInDownState extends State<BounceInDown>
  ...
  Widget build(BuildContext context) {
    return BounceInDownGrowTransition(
      child: widget.child,
...
class BounceInDownGrowTransition extends StatelessWidget {
  const BounceInDownGrowTransition({
    Key? key,
    required this.child,
